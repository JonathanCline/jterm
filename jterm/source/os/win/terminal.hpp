...
namespace jterm::os
{
	...
	struct terminal_cell
	{
		...
		using color_type = color_rgb;

		color_type bkcolor{ 0, 0, 0 };
		color_type fgcolor{ 255, 255, 255 };
	...
	public:
		...
		void set_cursor_pos(size_t _x, size_t _y);
	...
	private:
		...
		terminal_buffer buffer_{ 64, 24 };
		terminal_buffer::size_type cursor_ = 0;

		struct color_span
		{
			terminal_buffer::size_type len = 0;

			terminal_cell::color_type fgcolor{ 255, 255, 255 };
			terminal_cell::color_type bkcolor{ 0, 0, 0 };
		};

		std::vector<terminal_cell::character_type> characters_;
		std::vector<color_span> colors_;

		terminal_cell::color_type foreground_{ 255, 255, 255 };
		terminal_cell::color_type background_{ 0, 0, 0 };
